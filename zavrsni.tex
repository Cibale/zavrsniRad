...
\lstset{language=Java,
 ...
 breaklines=true
 %inputencoding=utf8x
 %literate={č}{{\'c}}1 {ć}{{\~c}}1 {š}{{\'s}}1 {ž}{{\'z}}1 {đ}{{\'d}}1
 }
\begin{document}
...
public class BrojanjeRijeci {
	...
	public static void main(String[] args) {
		...
		SparkConf conf = new SparkConf().setMaster("local").setAppName("Brojanje rijeci");
		...
		JavaPairRDD<String, Integer> brojRijeci = rijeci.mapToPair(new PairFunction<String, String, Integer>() {
