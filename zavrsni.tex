...
Od linije \ref{line:initStart} do linije \ref{line:initEnd} inicijalizira se glavno računalo i ime aplikacije. Ovdje je to postavljeno na \texttt{local} budući da se aplikacija odvija na lokalnom računalu, a ne na grozu. Ime aplikacije postavljeno je po algoritmu kojeg aplikacija implementira.
